  ...
  return (
    <div className="space-y-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Configure your global settings and security options</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Encryption Key Management</h3>
          <p className="text-gray-600 mb-4">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4">
            <IdCard className="text-purple-600 w-6 h-6" />
          </div>
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Identity Provider Credentials</h3>
          <p className="text-gray-600 mb-4">
